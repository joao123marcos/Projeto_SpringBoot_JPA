...
public class Order implements Serializable{
    ...
    /*Como estou usando a associação um para um e quero que o meu pagamento tenha
    o mesmo id do pedido eu preciso usar cascade = CascadeType.ALL*/
    ...
    public Double getValueTotalOrder(){
        double sum = 0.0;
        for (OrderItem x : items) {
            sum += x.getSubtotalOrderItem();
        }
        return sum;
    }
